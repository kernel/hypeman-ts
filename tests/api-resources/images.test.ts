...
describe('resource images', () => {
  ...
  // Mock server tests are disabled
  test.skip('tag: only required params', async () => {
    const responsePromise = client.images.tag('name', { target: 'docker.io/library/nginx:stable' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  // Mock server tests are disabled
  test.skip('tag: required and optional params', async () => {
    const response = await client.images.tag('name', { target: 'docker.io/library/nginx:stable' });
  });
});
